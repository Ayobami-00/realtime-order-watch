...
const file_orders_proto_rawDesc = "" +
	"\n" +
	"\forders.proto\x12\x06orders\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8b\x02\n" +
	"\x05Order\x12\x19\n" +
	...
	"\x05order\x18\x01 \x01(\v2\r.orders.OrderR\x05order\"\x15\n" +
	"\x13StreamOrdersRequest\"/\n" +
	"\x12DeleteOrderRequest\x12\x19\n" +
	"\border_id\x18\x01 \x01(\tR\aorderId\":\n" +
	"\x13DeleteOrderResponse\x12#\n" +
	"\x05order\x18\x01 \x01(\v2\r.orders.OrderR\x05order2\xf2\x02\n" +
	"\fOrderService\x12F\n" +
	...
	"\x11UpdateOrderStatus\x12 .orders.UpdateOrderStatusRequest\x1a!.orders.UpdateOrderStatusResponse\x12<\n" +
	"\fStreamOrders\x12\x1b.orders.StreamOrdersRequest\x1a\r.orders.Order0\x01BLZJgithub.com/Ayobami-00/realtime-order-watch/order-admin-service/pb;orderspbb\x06proto3"
...
var file_orders_proto_depIdxs = []int32{
	12, // 0: orders.Order.created_at:type_name -> google.protobuf.Timestamp
	12, // 1: orders.Order.updated_at:type_name -> google.protobuf.Timestamp
	...
	9,  // 11: orders.OrderService.StreamOrders:input_type -> orders.StreamOrdersRequest
	2,  // 12: orders.OrderService.CreateOrder:output_type -> orders.CreateOrderResponse
	4,  // 13: orders.OrderService.GetOrder:output_type -> orders.GetOrderResponse
	6,  // 14: orders.OrderService.ListOrders:output_type -> orders.ListOrdersResponse
	8,  // 15: orders.OrderService.UpdateOrderStatus:output_type -> orders.UpdateOrderStatusResponse
	0,  // 16: orders.OrderService.StreamOrders:output_type -> orders.Order
